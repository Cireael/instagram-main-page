...
//  Instagram
//
//  Created by Julia on 09.04.2023.
//
...
class FeedViewController: UIViewController {
    ...
    private var items: [FeedItemType] = [
        .stories([
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user1", isAddButtonVisible: true, isNewStory: false),
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user2", isAddButtonVisible: false, isNewStory: true),
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user3", isAddButtonVisible: false, isNewStory: true),
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user4", isAddButtonVisible: false, isNewStory: true),
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user5", isAddButtonVisible: false, isNewStory: true),
            FeedStoriesItemCellInfo(image: UIImage(named: "dog")!, username: "user6", isAddButtonVisible: false, isNewStory: true)
        ]),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitle: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 439, comment: CommentShortInfo(username: "Another_dog", commentText: "haha"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitle: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 439, comment: CommentShortInfo(username: "Another_dog", commentText: "haha"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitle: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 439, comment: CommentShortInfo(username: "Another_dog", commentText: "haha"))),
        .post(FeedPostItemInfo(userImage: UIImage(named: "dog")!, username: "Some_dog", postSubtitle: "Sponsored", postImage: UIImage(named: "dog")!, numberOfLikes: 439, comment: CommentShortInfo(username: "Another_dog", commentText: "haha")))
    ]
...
private extension FeedViewController {
    ...
    func makeRightButtonItems() -> [UIBarButtonItem] {
